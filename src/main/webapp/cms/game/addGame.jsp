...
function check(){
	...
	flag = isNull("description","请输入游戏简介！") && flag;
...
<body>
<div class="location">
	您当前的位置—添加旗下游戏 <span style="color: #F00">${requestScope.message }</span>
</div>
<div class="checked">
	<form action="saveOrUpdateGame.do" method="post" enctype="multipart/form-data" >
	<table>
		<tr>
			<td>游戏名：</td>
			<td>
		...
		<tr>
			...
			<td>
				...
				<input type="hidden" id="qrCodeImg2" name="qrCodeImg1" value="${game.qrCodeImg }" />
	...
	<input type="hidden" id="hot" name="hot" value="0"/>
	</form>
</div>
</body>
</html>