...
function check(){
	var flag = true;
	flag = isNull("title","请输入中文标题！") && flag;
...
<div class="checked">
	...
	<table>
		...
		<tr>
			<td>英文标题：</td>
			<td>
				<input type="text" id="englishTitle" name="englishTitle" value="${image.englishTitle }" />
		...
		<tr>
			<td>内容：</td>
			<td>
				<textarea rows="5" cols="40" id="content" name="content">${image.content }</textarea>
