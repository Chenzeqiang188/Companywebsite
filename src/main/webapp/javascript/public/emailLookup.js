		...
		var st='<h4 style="padding:8px;">\
   	  ...
   	  <form action="' + dizhi +'" method="post" name=form1>\
       		<table border="0" cellspacing="0" cellpadding="0" width="100%" >\
                <tr>\
                	<td height="31" align="right">回复标题：<span style="color:#FF0000">*</span></td>\
                  <td><table  border="0" cellspacing="0" cellpadding="0" width="100%"><tr><td><input type="text" name="title" /></td></tr>\</table></td>\
                </tr>\
                <tr>\
	            	<td height="31" align="right">回复内容：<span style="color:#FF0000">*</span></td>\
	              <td><table  border="0" cellspacing="0" cellpadding="0" width="100%"><tr><td><textarea name="text" cols="40" rows="8"></textarea></td></tr>\</table></td>\
	            </tr>\
                <tr>\
                	<td height="45"></td>\
                	<td>\
