...
jQuery.extend(jQuery.validator, {
    ...
    messages: {
        ...
        rangeValue: jQuery.format("\u8bf7\u8f93\u5165\u4e00\u4e2a\u4ecb\u4e8e {0} \u548c {1} \u4e4b\u95f4\u7684\u503c"),
    ...
    methods: {
        ...
        telephone: function(value, element) {
            return this.optional(element) || /^(\d{3,4}|\d{3,4}-?)?[1-9]\d{6,7}$/.test(value);
        },
        //\u81ea\u5b9a\u4e49"\u624b\u673a\u53f7\u7801"\u9a8c\u8bc1
        mobilephone: function(value, element) {
            return this.optional(element) || /^1[3,5]\d{9}$/.test(value);
        },
        phone: function(value, element) {
            return this.optional(element) || /^(1[3,5]\d{9}|(0\d{2,3}|0\d{2,3}-?)?[1-9]\d{6,7})$/.test(value);
        },
