    ...
    $.fn.visualize = function(options, container) {
        return $(this).each(function() {
            ...
            var o = $.extend({
                ...
                colors: ['#db0404', '#da7510', '#2e9203', '#038a85', '#8d10ee', '#5a3b16', '#26a4ed', '#f45a90', '#586366'],
                textColors: [], //corresponds with colors array. null/undefined items will fall back to CSS
                parseDirection: 'x', //which direction to parse the table data
                pieMargin: 20, //pie charts only - spacing around pie
                pieLabelPos: 'inside',
                lineWeight: 1.5, //for line and area - stroke weight
                barGroupMargin: 10,
            ...
            if (o.type == 'pie') {
			    ...
			    .attr({
			        'height': o.height < 150 ? 150 : o.height,
			        'width': o.width
			    });
            } else {
                var canvas = $(canvasNode)
            ...
            if (o.appendKey) {
                ...
                self.find(selector).each(function(i) {
                    //alert(o.type);
                    if (o.type == 'pie') {
                        $('<li><span class="visualize-key-color" style="background: ' + dataGroups[i].color + '"></span><span>&nbsp;&nbsp;&nbsp;</span><span class="visualize-key-label">' + $(this).text() + '</span></li>')
                        .appendTo(newKey);
                    }
                    else {
